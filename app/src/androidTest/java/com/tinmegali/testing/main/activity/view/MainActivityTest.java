package com.tinmegali.testing.main.activity.view;
...
import com.tinmegali.testing.R;
import com.tinmegali.testing.main.activity.MVP_Main;
import com.tinmegali.testing.util.ChildClickAction;
import com.tinmegali.testing.util.CustomViewHolderMatcher;
...
public class MainActivityTest {
    ...
    public void reconfigTest(){
        rotateDev();
        assertNotNull( testRule.getActivity().mPresenter );
    }

    private int orientation = ActivityInfo.SCREEN_ORIENTATION_PORTRAIT;
    private void rotateDev(){
        if ( orientation == ActivityInfo.SCREEN_ORIENTATION_PORTRAIT )
            orientation = ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE;
        else
            orientation = ActivityInfo.SCREEN_ORIENTATION_PORTRAIT;

        testRule.getActivity().setRequestedOrientation( orientation );
    }
